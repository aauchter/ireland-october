    ...
    picks: [
      {
        ...
        booking: bookingSearch('Ashling Hotel Dublin', '2026-10-01', '2026-10-02'),
    ...
    picks: [
      {
        ...
        booking: bookingSearch('Carton House Maynooth', '2026-10-05', '2026-10-08'),
    ...
    picks: [
      {
        ...
        booking: bookingSearch('The Dean Dublin', '2026-10-09', '2026-10-12'),
